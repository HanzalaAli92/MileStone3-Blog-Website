...
const ContactUs = () => {
  return (
    <section className="bg-gradient-to-b from-indigo-600 to-purple-600 py-16 pt-28">
      <div className="container mx-auto px-6 text-center">
        <h1 className="text-4xl font-extrabold text-white mb-8">
          Contact TechnoMind Blog
        </h1>
        <p className="text-lg text-gray-200 mb-12 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 bg-gradient-to-r from-indigo-700 to-purple-600 p-8 rounded-xl shadow-lg">
          <div className="flex flex-col justify-center items-center space-y-6 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="flex flex-col justify-center items-center space-y-6 bg-white rounded-xl shadow-lg p-6">
            ...
            >
              <div className="flex space-x-4">
                <div className="w-1/2">
                  <input
                    ...
                    className="w-full px-4 py-2 border border-indigo-300 bg-transparent rounded-xl"
                    required
                  />
                </div>
                <div className="w-1/2">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-indigo-800 text-white font-semibold rounded-xl hover:bg-indigo-600 transition duration-300"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="mt-12 bg-indigo-800 text-white p-6 rounded-xl shadow-lg">
