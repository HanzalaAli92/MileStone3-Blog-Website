...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-indigo-800 to-purple-600 text-white py-8 px-14">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <select className="bg-indigo-700 text-white px-4 py-2 rounded-xl focus:outline-none">
