...
const AboutPage = () => {
  return (
    <section id="about" className="bg-gradient-to-r from-indigo-50 to-purple-100 text-gray-800 min-h-screen py-16 px-6">
      {/* Hero Section */}
      <div className="container mx-auto text-center">
        <h1 className="text-5xl font-extrabold text-indigo-800 mb-6">About Us</h1>
      ...
      <div className="container mx-auto flex flex-wrap lg:flex-nowrap justify-between items-center mt-12">
        ...
        <div className="lg:w-1/2 w-full lg:pl-10 space-y-6">
          <h2 className="text-3xl font-semibold text-indigo-800">A Platform Built for Creators</h2>
          ...
          <Link href="/blogs">
            <button className="bg-indigo-800 hover:bg-indigo-700 text-white font-semibold py-3 px-8 rounded-xl shadow-md transition-transform transform hover:scale-105">
              Explore Blogs
            </button>
          </Link>
        </div>
      ...
      <div className="mt-16 container mx-auto text-center">
        <h2 className="text-4xl font-bold text-indigo-800 mb-8">Why Choose Us?</h2>
        <div className="grid md:grid-cols-3 gap-12">
          {/* Feature 1 */}
          <div className="bg-white rounded-xl p-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-xl font-semibold text-indigo-800 mb-4">Intuitive Design</h3>
            <p className="text-lg text-gray-600">
          ...
          {/* Feature 2 */}
          <div className="bg-white rounded-xl p-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-xl font-semibold text-indigo-800 mb-4">SEO Tools</h3>
            <p className="text-lg text-gray-600">
          ...
          {/* Feature 3 */}
          <div className="bg-white rounded-xl p-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-xl font-semibold text-indigo-800 mb-4">Customizable Themes</h3>
            <p className="text-lg text-gray-600">
      ...
      <div className="mt-16 container mx-auto text-center">
        <h2 className="text-4xl font-bold text-indigo-800 mb-8">What Our Users Say</h2>
        <div className="flex flex-wrap justify-center gap-8">
          {/* Testimonial 1 */}
          <div className="bg-indigo-800 text-white p-8 rounded-xl shadow-lg max-w-md">
      ...
      <div className="mt-16 bg-indigo-800 text-white text-center py-12 rounded-xl">
        ...
        <Link href="/signup">
          <button className="bg-indigo-50 hover:bg-indigo-900 text-gray-800 hover:text-white font-semibold py-3 px-8 rounded-xl shadow-md transition-transform transform hover:scale-105">
            Get Started
          </button>
        </Link>
      </div>
